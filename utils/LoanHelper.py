...
class LoanHelper(object):
	def __init__(self, csv_file='/home/zhangpan/software/flguard_torch/data/lending-club-loan-data/loan_processed.csv'):
...
if __name__ == '__main__':
	lh = LoanHelper('/home/zhangpan/software/flguard_torch/data/lending-club-loan-data/loan_processed.csv')
